...
import { createRippleTransaction, generateWalletFromSeed, generateXRPWallet, randomWallet, decodeBlobTx, createScripts, createInscribeTxs, XRPL_WSC_TESTNET, XRPL_WSC_MAINNET } from "../dist";
...
const receiverAddress = "rhZNbGEm4Kx3MUzn56sg5bKgTtxzmfpGsG";
const amount = new BigNumber(20 * 1e6);
...
describe("XRPL create txs inscribe data", async () => {
    ...
    it("send XRPL", async () => {
        ...
        const client = new Client(XRPL_WSC_MAINNET); // Testnet URL
        ...
        console.log("txID, txFee: ", txID, txFee);
    });
